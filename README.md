...
- [링크](https://www.notion.so/teamsparta/12-1aab17f3a5804237b7bfb19e48534f65)
...
- 몬스터
    ...
    - 몬스터 10마리 처치할 때마다 몬스터 레벨이 증가

    - 몬스터 레벨당 체력과 공격력이 10씩 증가 & 몬스터 스폰 주기 0.5초씩 줄어듦
